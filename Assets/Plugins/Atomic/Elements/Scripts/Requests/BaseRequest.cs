...
{
    [Serializable]
    public sealed class BaseRequest : IRequest
    {
    ...
    [Serializable]
    public sealed class BaseRequest<T> : IRequest<T>
    {
        public bool Required => _required;
        public T Arg => _arg;
    ...
    [Serializable]
    public sealed class BaseRequest<T1, T2> : IRequest<T1, T2>
    {
        public bool Required => _required;
        ...
        public void Invoke(T1 direction, T2 deltaTime)
        {
            _required = true;
            _arg1 = direction;
            _arg2 = deltaTime;
    ...
    [Serializable]
    public sealed class BaseRequest<T1, T2, T3> : IRequest<T1, T2, T3>
    {
        public bool Required => _required;
        public T1 Arg1 => _arg1;
        public T2 Arg2 => _arg2;
